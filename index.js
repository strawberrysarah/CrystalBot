        ...
        if (!targetUser) return message.reply("Tag someone to ship! `cry!ship @user`");
                ...
                const isVIP = userId === '1471141307400454245' || targetUser.id === '1471141307400454245';
                    const percent = isVIP ? 100 : Math.floor(Math.random() * 101);
                        ...
                        // Clean usernames so special decorative fonts/symbols don't break the canvas text
                            const cleanStr = str => str.replace(/[^\w\s]/gi, '').trim() || 'User';
                                const raw1 = cleanStr(message.author.username);
                                    const raw2 = cleanStr(targetUser.username);
                                        const shipName = raw1.substring(0, Math.ceil(raw1.length / 2)) + raw2.substring(Math.ceil(raw2.length / 2));
                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.bezierCurveTo(cx, cy + (h + topCurveHeight) / 2, cx + w / 2, cy + (h + topCurveHeight) / 2, cx + w / 2, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.bezierCurveTo(cx + w / 2, cy, cx, cy, cx, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                                              ctx.closePath();
                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                    const heartGrad = ctx.createLinearGradient(cx - w / 2, cy, cx + w / 2, cy + h);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.shadowBlur = 4;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ctx.fillText('- -  C O M P A T I B I L I T Y  - -', 400, 52);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ctx.restore();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // 6. Percentage Text inside the Heart
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.save();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.textAlign = 'center';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    const attachment = new AttachmentBuilder(buffer, { name: 'ship.png' });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          let tagline = isVIP 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ? "Sarah is literally a perfect match for anyone. It's just science! ✨"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          : percent > 80 ? "True Love is in the air! W rizz. 💖" 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  : percent > 50 ? "Definitely some chemistry here! 💕" 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          : percent > 20 ? "Maybe just stay friends bro. 🤷" 
