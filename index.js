        ...
        if (!targetUser) return message.reply("Tag someone to ship! `cry!ship @user`");
                ...
                const isVIP = userId === '1471141307400454245' || targetUser.id === '1471141307400454245';
                    const percent = isVIP ? 100 : Math.floor(Math.random() * 101);
                        ...
                        // Clean names to handle special symbols gracefully
                            const cleanStr = str => str.replace(/[^\w\s]/gi, '').trim() || 'User';
                                const raw1 = cleanStr(message.author.username);
                                    const raw2 = cleanStr(targetUser.username);
                                            ...
                                            // Capitalize blended ship name
                                                let blended = raw1.substring(0, Math.ceil(raw1.length / 2)) + raw2.substring(Math.ceil(raw2.length / 2));
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      const size = Math.random() > 0.88 ? 3 : 1.5;
                                                                                                                                                                                                              ctx.fillRect(Math.random() * canvas.width, Math.random() * canvas.height, size, size);
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          ctx.globalAlpha = 1.0;
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                // 3. User Avatars (Rounded cards with soft neon pink glow)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ctx.bezierCurveTo(cx, cy + (h + topCurveHeight) / 2, cx + w / 2, cy + (h + topCurveHeight) / 2, cx + w / 2, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.bezierCurveTo(cx + w / 2, cy, cx, cy, cx, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.closePath();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                // Deep magenta heart fill with intense neon glow
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ctx.fillStyle = '#b80058';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ctx.shadowColor = '#ff2b8c';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.shadowBlur = 30;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.fill();

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              // Sharp white neon border around heart
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.lineWidth = 5;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.strokeStyle = '#ffffff';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ctx.stroke();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ctx.restore();

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // 5. TOP TEXT: "Crystal Bond" (Glowing Cursive)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.save();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ctx.shadowBlur = 18;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ctx.fillText('Crystal Bond', 450, 72);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ctx.restore();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  // 6. CENTER TEXT: Ship Percentage inside the heart (Italic Cursive)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.save();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ctx.textAlign = 'center';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ctx.shadowBlur = 12;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.fillText(`${percent}%`, 450, 238);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.restore();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              // 7. BOTTOM TEXT: Ship Name (Large Glowing Cursive)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.save();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.textAlign = 'center';
