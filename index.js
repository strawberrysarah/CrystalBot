        ...
        if (!targetUser) return message.reply("Tag someone to ship! `cry!ship @user`");
                ...
                const isVIP = userId === '1471141307400454245' || targetUser.id === '1471141307400454245';
                    const percent = isVIP ? 100 : Math.floor(Math.random() * 101);
                        ...
                        // Blended Ship Name (First half of Author + Second half of Target)
                                              ...
                                              await message.channel.sendTyping();
                                                    ...
                                                    const canvas = createCanvas(800, 450);
                                                          const ctx = canvas.getContext('2d');
                                                                ...
                                                                // 1. Cosmic Crystal Gradient Background
                                                                      const bgGradient = ctx.createLinearGradient(0, 0, 800, 450);
                                                                            bgGradient.addColorStop(0, '#1c0335');
                                                                                  bgGradient.addColorStop(0.5, '#2f0847');
                                                                                        bgGradient.addColorStop(1, '#ff3b7c');
                                                                                              ctx.fillStyle = bgGradient;
                                                                                                    ctx.fillRect(0, 0, canvas.width, canvas.height);

                                                                                                          // 2. Crystal Sparkles & Stars
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          ctx.clip();
                                                                                                                                                                                                                                                                                                                  ctx.drawImage(img, x, y, size, size);
                                                                                                                                                                                                                                                                                                                          ctx.restore();
                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                drawRoundedAvatar(avatar1, 55, 95, 230);
                                                                                                                                                                                                                                                                                                                                      drawRoundedAvatar(avatar2, 515, 95, 230);

                                                                                                                                                                                                                                                                                                                                            // 4. Center Crystal Heart Vector
                                                                                                                                                                                                                                                                                                                                                  const drawCenterHeart = (cx, cy, width, height) => {
                                                                                                                                                                                                                                                                                                                                                          ctx.save();
                                                                                                                                                                                                                                                                                                                                                                  ctx.beginPath();
                                                                                                                                                                                                                                                                                                                                                                          const topCurveHeight = height * 0.3;
                                                                                                                                                                                                                                                                                                                                                                                  ctx.moveTo(cx, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                          ctx.bezierCurveTo(cx, cy, cx - width / 2, cy, cx - width / 2, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                  ctx.bezierCurveTo(cx - width / 2, cy + (height + topCurveHeight) / 2, cx, cy + (height + topCurveHeight) / 2, cx, cy + height);
                                                                                                                                                                                                                                                                                                                                                                                                          ctx.bezierCurveTo(cx, cy + (height + topCurveHeight) / 2, cx + width / 2, cy + (height + topCurveHeight) / 2, cx + width / 2, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.bezierCurveTo(cx + width / 2, cy, cx, cy, cx, cy + topCurveHeight);
                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.closePath();

                                                                                                                                                                                                                                                                                                                                                                                                                                  const heartGrad = ctx.createLinearGradient(cx - width / 2, cy, cx + width / 2, cy + height);
                                                                                                                                                                                                                                                                                                                                                                                                                                          heartGrad.addColorStop(0, percent < 30 ? '#4a1525' : '#ff4d8d');
                                                                                                                                                                                                                                                                                                                                                                                                                                                  heartGrad.addColorStop(1, percent < 30 ? '#1f0d14' : '#a21caf');
                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.fillStyle = heartGrad;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.shadowColor = percent < 30 ? '#1f0d14' : '#ff85c0';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.shadowBlur = 24;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.fill();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.strokeStyle = '#ffffff';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.stroke();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.restore();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        drawCenterHeart(400, 130, 150, 140);

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              // 5. Center Percentage Text
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.save();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.textAlign = 'center';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ctx.textBaseline = 'middle';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ctx.font = 'bold 44px "DejaVu Sans", Arial, sans-serif';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ctx.fillStyle = '#ffffff';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.shadowColor = '#000000';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.shadowBlur = 8;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ctx.fillText(`${percent}%`, 400, 205);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.restore();

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          // 6. Top Header & Bottom Ship Name
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ctx.save();
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ctx.textAlign = 'center';

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // Top title
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.font = 'bold 20px "DejaVu Sans", Arial, sans-serif';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.fillStyle = '#ffd1e9';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ctx.letterSpacing = '4px';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.shadowColor = '#000000';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.shadowBlur = 6;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ctx.fillText('—— C O M P A T I B I L I T Y ——', 400, 52);

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      // Bottom Ship Name
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ctx.font = 'bold 48px "DejaVu Sans", Arial, sans-serif';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ctx.fillStyle = '#ffffff';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ctx.shadowColor = '#ff2a85';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ctx.shadowBlur = 16;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ctx.fillText(shipName, 400, 395);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ctx.restore();

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                const buffer = await canvas.toBuffer('image/png');
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      const attachment = new AttachmentBuilder(buffer, { name: 'ship.png' });

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // Only the tagline is sent in the message text
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  let tagline = isVIP 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ? "Aww it's crystal magic, purely science based! 🥹"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  : percent > 80 ? "True Love is in the air! Crystal approved. 💖" 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          : percent > 50 ? "Definitely some chemistry here! Ahm ahm 💕" 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  : percent > 20 ? "Stay away from my cutie eww. 🤷" 
